...
// Source: https://raw.githubusercontent.com/DefinitelyTyped/DefinitelyTyped/7de6c3dd94feaeb21f20054b9f30d5dabc5efabd/openlayers/openlayers-2.10.0.d.ts
declare namespace OpenLayers {
    ...
    export class Feature {
        // TODO
        constructor(layer: OpenLayers.Layer, lonlat: OpenLayers.LonLat, data: any)
    }
    ...
    namespace Geometry {
        ...
        export class Collection extends Geometry {
             ...
             * Return a list of all points in this geometry.
             */
            getVertices(nodes?: boolean): OpenLayers.Geometry.Point[];
        }
    ...
    namespace Format {
        ...
        export class WKT {
            ...
            read(wkt: string): OpenLayers.Feature.Vector | OpenLayers.Feature.Vector[];
            write(features: any): string;
    ...
    namespace Layer {
        ...
        export class SphericalMercator {
            static forwardMercator(lon: number, lat: number): LonLat;
            static inverseMercator(x: number, y:number): LonLat;
            // TODO
        }
        export class TMS {
            // TODO
        ...
        export class Vector extends Layer {
            // TODO
            addFeatures(features: OpenLayers.Feature.Vector[], options?: any)
            removeAllFeatures(options?: any);
